...
public class BmiNoti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bmi_noti);
        ...
        else if(intbmi<16.9 && intbmi>16)
        {
            ...
            mbackground.setBackgroundColor(R.color.Prussian_Blue);
        ...
        else
        {
            ...
            mbackground.setBackgroundColor(R.color.Imperial_Red);
            mimageview.setImageResource(R.drawable.crosss);
            //  mimageview.setBackground(colorDrawable2);
        }
